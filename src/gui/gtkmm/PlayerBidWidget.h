...
#ifndef _PLAYER_BID_WIDGET_H__
#define _PLAYER_BID_WIDGET_H__

#include <PrefViewWidget.h>

class PlayerBidWidget : public PrefViewWidget {
public:
	PlayerBidWidget(Preference::BidType _bid, bool _isLeftAligned, bool isActivePlayer);
...
inline PlayerBidWidget::PlayerBidWidget(Preference::BidType _bid, bool _isLeftAligned, bool _isActivePlayer) :
	bid(_bid),
